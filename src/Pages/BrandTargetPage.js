...
const BrandTargetPage = () => {
    ...
    const fetchData = async () => {
      try {
        const [usersRes, brandsRes] = await Promise.all([
          axios.get("http://175.29.181.245:15001/getAllUser"),
          axios.get("http://175.29.181.245:15001/brands"),
        ]);
    ...
    const fetchTargets = async () => {
      ...
      try {
        ...
        const res = await axios.get(
          "http://175.29.181.245:15001/brandTargets",
          {
            params: { year, month },
          },
        );
  ...
  const saveTargets = async (userID) => {
    ...
    try {
      ...
      await axios.post("http://175.29.181.245:15001/brandTargets", {
        userID,
        year: parseInt(year),
      ...
      const res = await axios.get("http://175.29.181.245:15001/brandTargets", {
        params: { year, month },
      });
    ...
    try {
      const updates = Object.entries(tempTargets)
        ...
        .map(([userID, targets]) => {
          ...
          return axios.post("http://175.29.181.245:15001/brandTargets", {
            userID,
            year: parseInt(year),
            month: parseInt(month),
            targets: targetsArray,
